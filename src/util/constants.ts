import paleta from "../mystyles/paleta";
...
// export const HOST_WEB_API = "http://localhost/dzk2022WebApi/"; //"http://localhost:1884/"; // '"http://MOISES-PC:50688/"; //'"http://MOISES-PC/Klassica/";
